...
{
    public class naveButton : Button
    {
        private Color _borderColor = Color.White;
        private Color _onHoverBorderColor = Color.White;
        private Color _buttonColor = Color.FromArgb(102, 0, 202);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            RoundedRectangle.FillRoundedRectangle(e.Graphics, brush, roundedRectangle, 0);
        ...
        public Color NaveOnHoverBorderColor
        {
        ...
        public Color NaveOnHoverButtonColor
        {
        ...
        public Color NaveOnHoverTextColor
        {
